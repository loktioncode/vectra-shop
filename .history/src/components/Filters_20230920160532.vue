<template>
    <div class="flex flex-row items-center space-y-2 md:space-y-0 md:space-x-2 w-full">
      <!-- Product Count Display -->
      <div class="text-lg font-semibold mb-2 md:mb-0 w-3/12">
        Total Products: {{ filteredProducts.length }}
      </div>
  
      <!-- Search Form -->
      <div class="flex items-center space-x-2 w-4/12 md:w-auto">
