    ...
    <div class=" dark:text-gray-100 border-2 border-gray-100 hover:border-red-600">
      <div class="lg:bg-red-700 md:bg-blue-700 sm:bg-yellow-400 lg:px-0 px-4">
        <img :src="product.image" :alt="product.title + ' image'"
          class="xl:object-scale-down xl:p-4  md:p-2 object-center w-full sm:max-h-72 mx-auto rounded-t-md dark:bg-white m-8" />
      </div>
  
      <div class="flex flex-col justify-between p-6 space-y-8">
        <div>
          <h2 class="text-3xl font-semibold text-gray-800 truncate">{{ product.title }}</h2>
          <p class="text-gray-400 w-full">Curabitur luctus erat nunc, sed .</p>
        </div>
