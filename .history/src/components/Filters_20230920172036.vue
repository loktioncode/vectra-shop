<template>
    ...
    <div class="relative text-gray-600 focus-within:text-gray-400">
      ...
      <input type="search" name="q" class="py-2 text-md text-black rounded pl-10  border border-gray-300"  placeholder="Search..." autocomplete="off">
      <span class="absolute inset-y-0 right-0 flex items-center pl-2 bg-black">
        <button type="submit" class="p-1 mr-1 focus:outline-none focus:shadow-outline rounded">
