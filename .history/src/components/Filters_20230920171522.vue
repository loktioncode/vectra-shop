<template>
    ...
    <div class="relative text-gray-600 focus-within:text-gray-400">
      ...
      <input type="search" name="q" class="py-2 text-sm text-black  rounded-md pl-10 focus:outline-none focus:bg-white focus:text-gray-900 border-1 border-black-600"  placeholder="Search..." autocomplete="off">
    </div>
