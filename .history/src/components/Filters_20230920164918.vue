<template>
    <div class="flex lg:flex-row sm:flex-col items-center space-y-2 md:space-y-0 md:space-x-2 w-full py-5">
        <div class="flex lg:justify-start md:justify-start sm:flex-col w-6/12">
            <!-- Product Count Display -->
            <div class="text-lg mb-2 md:mb-0 w-4/12">
        ...
        <div class="flex justify-end w-6/12 pr-12">
            <!-- Sort Dropdown -->
