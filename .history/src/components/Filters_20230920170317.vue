            ...
            <div class="flex items-center w-7/12">
                ...
                <fieldset class="w-full space-y-1 dark:text-gray-100">
                    ...
                    <div class="relative">
                        ...
                        <input v-model="searchTerm" type="search" name="Search" placeholder="Search..."
                            class="w-32 py-2 pl-10 text-sm rounded-md sm:w-auto focus:outline-none  focus:dark:border-violet-400">
                    </div>
                </fieldset>
                <button @click="clearSearch" v-if="searchTerm" class="text-red-500 hover:text-red-700 focus:outline-none">
                    Clear
